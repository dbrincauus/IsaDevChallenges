...
(function(global, factory) {
  ...
  var Rejection = /** @class */ (function() {
    ...
    Rejection.prototype.toString = function() {
      ...
      var _a = this,
        ...
        message = _a.message;
      return (
        'Transition Rejection($id: ' + $id + ' type: ' + type + ', message: ' + message + ', detail: ' + detail + ')'
      );
    };
  ...
  })(exports.TransitionHookScope || (exports.TransitionHookScope = {})); /** for typedoc */
  ...
  var Transition = /** @class */ (function() {
    ...
    Transition.prototype.redirect = function(targetState) {
      ...
      var matchingEnteringNodes = PathUtils.matching(
  ...
  var StateParams = /** @class */ (function() {
    ...
    return StateParams;
  })(); /** for typedoc */ /** for typedoc */ /** for typedoc */

  /** @module path */ /** @module resolve */ /** @module state */ var parseUrl = function(url) {
  ...
  /** @module state */ var StateMatcher = /** @class */ (function() {
  ...
  var ViewService = /** @class */ (function() {
    ...
    ViewService.prototype.sync = function() {
      var _this = this;
      var uiViewsByFqn = this._uiViews
        .map(function(uiv) {
          return [uiv.fqn, uiv];
        })
        .reduce(applyPairs, {});
  ...
  var TransitionService = /** @class */ (function() {
    ...
    TransitionService.prototype._defineEvent = function(
      ...
      var eventType = new TransitionEventType(
        name,
        hookPhase,
        hookOrder,
        criteriaMatchPath,
  ...
  var $injector = {
    ...
    invoke: function(fn, context, locals) {
      ...
      var ensureExist = assertPredicate(
        function(key) {
  ...
  var PushStateLocationService = /** @class */ (function(_super) {
     ...
     * If <base href='http://localhost:8087/base/index.html'>, this returns '/base'.
     * If <base href='/base'>, this returns ''.
     * If <base href='http://localhost:8087'>, this returns ''.
     * If <base href='http://localhost:8087/'>, this returns ''.
     *
  ...
  var hashLocationPlugin = locationPluginFactory(
  ...
  var pushStateLocationPlugin = locationPluginFactory(
  ...
  var memoryLocationPlugin = locationPluginFactory(
      ...
      /** @hidden */ this.$get = [
        ...
        function($http, $templateCache, $injector$$1) {
          _this.$templateRequest =
            $injector$$1.has && $injector$$1.has('$templateRequest') && $injector$$1.get('$templateRequest');
          _this.$http = $http;
